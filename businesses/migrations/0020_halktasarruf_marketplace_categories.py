...
OFFICIAL_CATEGORIES = (
    (
        "firin-pastane",
        "Fırın & Pastane",
        "Fırın ve pastane odaklı işletmeleri tek katalogda toplayan resmi HalkYemek kategorisi.",
        10,
    ),
    (
        "kafe-kahve-zincirleri",
        "Kafe & Kahve Zincirleri",
        "Kafe ve kahve zinciri işletmelerini tek katalogda toplayan resmi HalkYemek kategorisi.",
        20,
    ),
    (
        "marketler",
        "Marketler",
        "Market ve günlük ürün fırsatlarını tek katalogda toplayan resmi HalkYemek kategorisi.",
        30,
    ),
    (
        "fast-food-restoranlari",
        "Fast Food Restoranları",
        "Hızlı servis ve fast food işletmelerini tek katalogda toplayan resmi HalkYemek kategorisi.",
        40,
    ),
    (
        "doner-kebap-isletmeleri",
        "Döner-Kebap İşletmeleri",
        "Döner ve kebap işletmelerini tek katalogda toplayan resmi HalkYemek kategorisi.",
        50,
    ),
)

OLD_TO_NEW_SLUGS = {
    "burger": "fast-food-restoranlari",
    "pizza": "fast-food-restoranlari",
    "doner": "doner-kebap-isletmeleri",
    "kebap": "doner-kebap-isletmeleri",
    "tavuk-doner": "doner-kebap-isletmeleri",
    "et-doner": "doner-kebap-isletmeleri",
}

BUSINESS_CATEGORY_FALLBACKS = {
    "burger": "Fast Food Restoranları",
    "pizza": "Fast Food Restoranları",
    "fast food": "Fast Food Restoranları",
    "fast food restoranları": "Fast Food Restoranları",
    "döner": "Döner-Kebap İşletmeleri",
    "doner": "Döner-Kebap İşletmeleri",
    "kebap": "Döner-Kebap İşletmeleri",
    "kebab": "Döner-Kebap İşletmeleri",
    "döner-kebap": "Döner-Kebap İşletmeleri",
    "fırın": "Fırın & Pastane",
    "firin": "Fırın & Pastane",
    "pastane": "Fırın & Pastane",
    "kafe": "Kafe & Kahve Zincirleri",
    "cafe": "Kafe & Kahve Zincirleri",
    "kahve": "Kafe & Kahve Zincirleri",
    "market": "Marketler",
    "marketler": "Marketler",
}
...
def normalize_business_category(value):
    ...
    return BUSINESS_CATEGORY_FALLBACKS.get(text.casefold(), "Fast Food Restoranları")


def _move_assignments(*, old_category, new_category, BusinessCategoryAssignment, MenuItemMarketplaceCategoryAssignment):
...
def forwards(apps, schema_editor):
    ...
    for old_slug, new_slug in OLD_TO_NEW_SLUGS.items():
        ...
        _move_assignments(
            ...
            BusinessCategoryAssignment=BusinessCategoryAssignment,
            MenuItemMarketplaceCategoryAssignment=MenuItemMarketplaceCategoryAssignment,
        )
